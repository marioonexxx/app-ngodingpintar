...
class ProductController extends Controller
{
    ...
    {
        $query = Product::with(['categories', 'membership', 'vendor'])->where('product_type', 'source_code')->latest('id');
        ...
        return Frontend::render('Admin/Products', [
    ...
    {
        return Frontend::render('Admin/Products/Create', $this->formData());
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect('/admin/products?owner=admin&sort=latest')->with('success', 'Produk dibuat.');
    }

    public function edit(Product $product)
    {
        abort_if($product->product_type !== 'source_code', 404);

        $product->load('categories');

        return Frontend::render('Admin/Products/Edit', array_merge($this->formData(), [
            'product' => $product,
        ]));
    }
    ...
    public function update(Request $request, Product $product): RedirectResponse
    {
        ...
        return to_route('admin.products.index')->with('success', 'Produk diperbarui.');
    }
    ...
    private function validated(Request $request, ?int $ignoreId = null): array
    {
        $data = $request->validate([
            ...
            'coaching_topic_id' => ['nullable', 'exists:coaching_topics,id'],
