...
const deleteProduct = async (product) => {
    ...
    router.delete(`/mentor/classes/${product.id}`, {
        preserveScroll: true,
        ...
        <section class="mt-5 rounded-md bg-white p-5 shadow-sm shadow-sky-950/5">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div class="flex items-center gap-3">
                    ...
                    <Link href="/mentor/classes/create" class="rounded-md bg-[#0284c7] px-4 py-2 text-sm font-black text-white">Tambah</Link>
                </div>
                        ...
                        <tr v-for="product in products.data" :key="product.id" class="border-t border-slate-100">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex justify-end gap-2">
                                    <Link :href="`/mentor/classes/${product.id}/participants`" class="rounded-full bg-amber-50 px-3 py-1.5 text-xs font-bold text-amber-600 hover:bg-amber-100">Peserta</Link>
                                    <Link :href="`/mentor/classes/${product.id}/batches`" class="rounded-full bg-emerald-50 px-3 py-1.5 text-xs font-bold text-emerald-600 hover:bg-emerald-100">Batch</Link>
                                    <Link :href="`/mentor/classes/${product.id}/edit`" class="rounded-full bg-sky-50 px-3 py-1.5 text-xs font-bold text-[#0284c7] hover:bg-sky-100">Edit</Link>
