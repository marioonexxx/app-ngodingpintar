...
const formAction = computed(() => selected.value ? `/admin/categories/${selected.value.id}` : '/admin/categories');
        ...
        <section class="rounded-md bg-white p-6 shadow-sm shadow-sky-950/5">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-3 text-3xl font-black tracking-tight">Kategori Source Code</h1>
                    <p class="mt-3 text-sm text-slate-500">Kelola kategori untuk pengelompokan katalog NgodingPintar.id.</p>
                </div>
                ...
                <table class="w-full min-w-[760px] text-left text-sm">
                    ...
                    <tbody>
                        <tr v-for="category in categories.data" :key="category.id" class="border-t border-slate-100">
                            ...
                            <td class="px-4 py-4">{{ category.products_count }} produk</td>
                            <td class="px-4 py-4">
